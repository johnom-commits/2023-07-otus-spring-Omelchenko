...
Выполняется на основе предыдущего домашнего задания плюс сам функционал тестирования.
...
8. Файл настроек и файл с вопросами, для тестов должны быть свои.
9. Scanner, PrintStream и другие стандартные типы в контекст класть не нужно! 
